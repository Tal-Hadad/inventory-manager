...
export default function EstimatedProfitCard({
  ...
  return (
    <div className="row-span-1 xl:row-span-2 rounded-2xl bg-white p-6 shadow-md dark:bg-zinc-900">
      <div className="flex items-start justify-between">
        ...
        <div className="rounded-full bg-emerald-500/10 p-3 text-emerald-500 dark:bg-emerald-400/10 dark:text-emerald-300">
